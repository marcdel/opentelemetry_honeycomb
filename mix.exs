defmodule OpenTelemetry.Honeycomb.MixProject do
  ...
  defp deps() do
    [
      ...
      {:opentelemetry, github: "open-telemetry/opentelemetry-erlang", override: true, sparse: "apps/opentelemetry"},
      {:opentelemetry_api, github: "open-telemetry/opentelemetry-erlang", override: true, sparse: "apps/opentelemetry_api"},
